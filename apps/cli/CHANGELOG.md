...
- b187fe4: Improve the Hermit CLI release with safer runtime behavior, better scripting support, and stronger test coverage.
...
- dbe995c: Harden the CLI and expand its scripting and automation support.
